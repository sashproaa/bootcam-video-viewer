...
domains=(ec2-18-193-43-215.eu-central-1.compute.amazonaws.com www.ec2-18-193-43-215.eu-central-1.compute.amazonaws.com)
rsa_key_size=4096
data_path="./docker/nginx/certbot"
email="a.proskurin@quantumobile.com" # Adding a valid address is strongly recommended
