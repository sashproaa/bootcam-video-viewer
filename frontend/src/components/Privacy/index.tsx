    ...
    >
      <div className={cls.privacy}>
        ...
        <p>
          ...
          player.quantumobile.com (далее – Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://player.quantumobile.com.
        </p>
        <p>
        ...
        https://player.quantumobile.com. 2.9. Персональные данные, разрешенные
        ...
        https://player.quantumobile.com. 2.11. Предоставление персональных
        ...
        юридическому лицу. 2.14. Уничтожение персональных данных – любые
        ...
        обрабатывать следующие персональные данные Пользователя 5.1. Фамилия,
        имя, отчество. 5.2. Электронный адрес. 5.3. Номера телефонов. 5.4. Год,
        месяц, дата и место рождения. 5.5. Фотографии. 5.6. Также на сайте
        происходит сбор и обработка обезличенных данных о посетителях (в т.ч.
        файлов «cookie») с помощью сервисов интернет-статистики (Яндекс Метрика
        и Гугл Аналитика и других). 5.7. Вышеперечисленные данные далее по
        тексту Политики объединены общим понятием Персональные данные. 5.8.
        ...
        условия, предусмотренные ст. 10.1 Закона о персональных данных. 5.10.
        ...
        защите прав субъектов персональных данных. 5.10.1 Согласие на обработку
        персональных данных, разрешенных для распространения, Пользователь
        предоставляет Оператору непосредственно. 5.10.2 Оператор обязан в срок
        не позднее трех рабочих дней с момента получения указанного согласия
        ...
        данных, разрешенных для распространения. 5.10.3 Передача
        ...
        Оператором, которому оно направлено. 5.10.4 Согласие на обработку
        ...
        5.10.3 настоящей Политики в отношении обработки персональных данных. 6.
        Принципы обработки персональных данных 6.1. Обработка персональных
        данных осуществляется на законной и справедливой основе. 6.2. Обработка
        ...
        целям их обработки. 6.5. Содержание и объем обрабатываемых персональных
        ...
        содержащимся на веб-сайте https://player.quantumobile.com. 7.2. Также
        ...
        privacy@player.quantumobile.com с пометкой «Отказ от уведомлений о новых
        продуктах и услугах и специальных предложениях». 7.3. Обезличенные
        ...
        документы Оператора; – федеральные законы, иные нормативно-правовые акты
        в сфере защиты персональных данных; – согласия Пользователей на
        обработку их персональных данных, на обработку персональных данных,
        разрешенных для распространения. 8.2. Оператор обрабатывает персональные
        ...
        сайте https://player.quantumobile.com или направленные Оператору
        ...
        согласие свободно, своей волей и в своем интересе. 9. Условия обработки
        ...
        и свободы субъекта персональных данных. 9.6. Осуществляется обработка
        ...
        лицу для исполнения обязательств по гражданско-правовому договору. 10.3.
        ...
        privacy@player.quantumobile.com с пометкой «Актуализация персональных
        ...
        privacy@player.quantumobile.com с пометкой «Отзыв согласия на обработку
        ...
        договора, стороной которого является субъект персональных данных. 13.
        ...
        privacy@player.quantumobile.com. 14.2. В данном документе будут отражены
        ...
        Интернет по адресу https://player.quantumobile.com/privacy.
      </div>
    </ModalWin>
  );
}
